...
namespace Infrastructure.Services
{
    public class OrderService : GenericRepository<Order>, IOrderService
    {
        ...
        public async Task<Order> CreateOrderAsync(string buyerEmail, int deliveryMethodId, string basketId, Address shippingAdress)
        {
            ...
            if (order != null)
            {
                order.ShipToAddress = shippingAdress;
            ...
            {
                //create order
                 order = new Order(items, buyerEmail, shippingAdress, deliveryMethod, subtotal, basket.PaymentIntentId);
        ...
        public async Task<Order> GetOrderByIdSpecAsync(int id)
        {
